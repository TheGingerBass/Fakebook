...
CREATE TABLE CITIES (
    ...
    CONSTRAINT loc UNIQUE (CITY_NAME, STATE_NAME, COUNTRY_NAME),
    PRIMARY KEY(CITY_ID)
);
...
CREATE TABLE PROGRAMS (
    ...
    CONSTRAINT degreeStuff UNIQUE(INSTITUTION, CONCENTRATION, DEGREE),
...
CREATE TABLE EDUCATION (
    ...
    CONSTRAINT year UNIQUE (USER_ID, PROGRAM_ID), 
    FOREIGN KEY(USER_ID) REFERENCES USERS(USER_ID),
...
CREATE TABLE PARTICIPANTS (
    ...
    FOREIGN KEY(USER_ID) REFERENCES USERS(USER_ID),
    CHECK(CONFIRMATION IN ('NOT_REPLIED','ATTENDING','DECLINES','UNSURE')),
